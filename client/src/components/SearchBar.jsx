    ...
    <div className="relative w-full">
      ...
      >
        <div className="flex w-full space-x-2 h-12 items-start">
          <ul
            className={
              "border-zinc-300 border-1 flex-1 rounded-3xl bg-white" +
              (shadow ? " shadow-md" : "")
            }
            onFocus={handleFocus}
            onBlur={handleBlur}
          ...
          >
            <li className="px-4 py-2 cursor-pointer flex items-center space-x-2 h-12">
              <FontAwesomeIcon
                ...
                className="bg-transparent text-zinc-800 text-md"
              />
              <input
                name="query"
                type="search"
              ...
              <>
                ...
                {suggestions.map((s, i) => (
                  <li
                    ...
                    className="px-4 py-2 h-12 hover:bg-zinc-100 cursor-pointer rounded-full flex items-center space-x-2"
                  >
                    <FontAwesomeIcon
          ...
          <button
            type="submit"
            className="bg-zinc-800 text-zinc-100 pl-2 pr-4 py-2 rounded-full cursor-pointer h-12"
          >
            <FontAwesomeIcon
              icon={faMagnifyingGlass}
              className="text-zinc-100 text-md px-2"
            />
            Search
          </button>
        </div>
